...
```{r}
firealt = read_csv("../outputs/dataset/FireAltEstimatedRawDataSpatialJoin.csv")
```
...
```{r}
write_csv(pairs , '../outputs/dataset/FireALTPairsBurnedUnburned.csv')
```
...
```{r}
write.csv(SiteLevel, file = "../outputs/dataset/FireAltEstimatedSiteLevel.csv", row.names=FALSE)
```