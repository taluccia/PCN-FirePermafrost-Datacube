...
```{r}
data = read_csv("../outputs/era5Clean/RawDataWithERA5_2025-02-22.csv")
```
...
```{r}
write.csv(cleanDataCombine, file = "../outputs/dataset/FireAltEstimated_2025-02-22.csv", row.names=FALSE)
```
