...
```{r}
f <- list.files(path = "../data/ERA5DataEE20250222/",
...
write.csv(combineAll,file = "../outputs/era5Clean/RawDataWithERA5_2025-02-22.csv", row.names = FALSE)
```

```{r end-timer, echo=TRUE}
toc()
```
