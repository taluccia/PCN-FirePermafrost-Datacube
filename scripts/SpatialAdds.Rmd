...
st_write(permResPtPlots_Wgs, "../outputs/spatialDataCreate/FireAltEstimatedPlotLevelSpatialJoin.shp", driver="ESRI Shapefile")
```

## write to csv

```{r}
write.csv(plots, file = "../outputs/dataset/FireAltEstimatedPlotLevelSpatialJoin.csv", row.names=FALSE)
```
...
```{r}
write.csv(rawData, file = "../outputs/dataset/FireAltEstimatedRawDataSpatialJoin.csv", row.names=FALSE)
```