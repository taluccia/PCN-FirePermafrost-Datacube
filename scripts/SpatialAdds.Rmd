...
```{r}
write.csv(plots, file = "../outputs/dataset/FireAltEstimatedPlotLevel.csv", row.names=FALSE)
```
...
```{r}
write.csv(rawData, file = "../outputs/dataset/FireAltEstimatedRawData.csv", row.names=FALSE)
```